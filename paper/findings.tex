...
investigators to submit more than 40 distinct applications in a single round.\footnote{NOT-OD-25-132, \emph{Background}: ``there is evidence that the use of AI tools has enabled Principal Investigators to submit more than 40 distinct applications in a single application submission round.'' The notice cites no source for the figure, so it is reported here as the funder's stated rationale rather than as a measured quantity.
\wa{https://web.archive.org/web/20260728200334/https://grants.nih.gov/grants/guide/notice-files/NOT-OD-25-132.html}{28 July 2026}} If
